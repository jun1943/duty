...
<title>勤务管理——工作日历</title> 
  ...
  <body oncontextmenu=self.event.returnValue=false>
	...
	<div class="dateBox">
	 ...
	 <!-- 报备详细明细窗体内容 -->
 	<div id="dutyDetailsForDaywindow"  title="警务报备情况" class="easyui-window clddtywindow" data-options="iconCls:'icon-tianyi-edit',modal:true,headerCls:'bbbb'" closed="true" 

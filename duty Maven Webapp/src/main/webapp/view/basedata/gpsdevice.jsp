...
<body class="easyui-layout gpslayout"   oncontextmenu=self.event.returnValue=false> 
	...
	<div data-options="region:'center'" class="gpscenter" > 
			...
			<div id="tbGpsdevice" class="btn-toolbar gpstoolbar" >
  				<div class="btn-group">
  					<a id="btnAddGpsdevice" href="javascript:void(0);" class="easyui-linkbutton"  iconcls="icon-tianyi-add"  onclick="btnAddGpsdevice('add')">新增</a>
		...
		<div id="gpsInfoinportwindow" class="easyui-window" title="导入数据选项" data-options="modal:true,headerCls:'bbbb'" closed="true" 

...
-->
<script src='<%=basePath%>script/duty/s.js'
    		...
    		<div class="dateBoxMainTItle">
	            ...
	            <div class="dateBoxMainTItleTxt">
	            	<div class="dateBoxMainTItleTxtDIv">
	                    ...
	                    <a href="javascript:void(0);" onclick="clearClipbord()" id="pasteBtn"><img src="asset/css/images/pastno.png" alt="取消剪切板数据" title="取消剪切板数据"  /></a>
	                </div>
	            </div>
        	</div>

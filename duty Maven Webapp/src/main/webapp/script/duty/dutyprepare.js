...
function initdatagridcontent(id) {
	var html = '<div id="tb_worksheet_'
			+ id
			+ '" class="btn-toolbar"><div class="btn-group">'
			+ ' <input id="starttime_'
			+ id
			+ '" class="easyui-timespinner"  style="width:80px;" required="required" data-options="min:\'00:00\',showSeconds:false" />     '
			+ ' <input id="endtime_'
			+ id
			+ '" class="easyui-timespinner"  style="width:80px;" required="required" data-options="min:\'00:01\',showSeconds:false" />'
			...
			+ ' <div id="contentTab_'
			+ id
			+ '" class="easyui-tabs" data-options="tools:\'#contentTab-tools_'
			+ id
			+ '\'" style="width:500px;height:300px"></div> '
			+ ' <div id="contentTab-tools_'
			+ id
			+ '"> '
			+ ' <a href="javascript:void(0)" class="easyui-linkbutton" data-options="plain:true,iconCls:\'icon-add\'" onclick="addPanel('
			+ id
			+ ')"></a> '
			+ ' <a href="javascript:void(0)" class="easyui-linkbutton" data-options="plain:true,iconCls:\'icon-remove\'" onclick="removePanel('
			+ id + ')"></a> ' + ' </div></div> ';
	return html;
};
var index = 0;
function addPanel(id) {
	...
	$('#contentTab_' + id).tabs(
			...
			{
				title : '班次' + index,
				content : '<div id="dt_shedule_' + id + '_' + index

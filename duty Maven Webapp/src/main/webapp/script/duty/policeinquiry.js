...
$(function() {
	...
	$('#dtReportSum').treegrid({
		...
		columns : [ [ {
			...
			title : '社区',
			field : "communityCount",
			align : 'right',
			width : 80
		}, {
			title : '巡区',
			field : "patrolAreaCount",
			align : 'right',
			width : 80
		}, {
			title : '卡点',
...
function packCriteria() {
	...
	criteria.beginTime2 = new Date(Date.parse(dateStr.replace(/-/g, "/")));
	// criteria.endTime2=new Date(dateStr);

	var h1 = $('#spnBeginTime').timespinner('getHours') < 10 ? "0"
			+ $('#spnBeginTime').timespinner('getHours') : $('#spnBeginTime')
			.timespinner('getHours');
	var m1 = $('#spnBeginTime').timespinner('getMinutes') < 10 ? "0"
			+ $('#spnBeginTime').timespinner('getMinutes') : $('#spnBeginTime')
			.timespinner('getMinutes');

	var h2 = $('#spnEndTime').timespinner('getHours') < 10 ? "0"
			+ $('#spnEndTime').timespinner('getHours') : $('#spnEndTime')
			.timespinner('getHours');
	var m2 = $('#spnEndTime').timespinner('getMinutes') < 10 ? "0"
			+ $('#spnEndTime').timespinner('getMinutes') : $('#spnEndTime')
			.timespinner('getMinutes');
	...
	criteria.beginTime = dateStr + " " + h1 + ":" + m1 + ":00";
	criteria.endTime = dateStr + " " + h2 + ":" + m2 + ":00";
	...
	var dt = $("#cmbdutytype").combotree('getValues');

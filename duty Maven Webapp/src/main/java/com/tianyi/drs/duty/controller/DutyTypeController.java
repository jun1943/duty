...
public class DutyTypeController {
	...
	public @ResponseBody String  loadProperties(
			HttpServletRequest request
			){
	
			List<DutyTypePropertyVM> ls=dutyTypeService.loadProperties();
			
			ListResult<DutyTypePropertyVM>  rs=new ListResult<DutyTypePropertyVM>(ls.size(),ls);
	...
	public @ResponseBody String  saveDutyType(
			...
			DutyTypeVM dtvm= (DutyTypeVM) JSONObject.toBean(jsObj,DutyTypeVM.class,classMap);
			
			dutyTypeService.save(dtvm);
			
			ObjResult<DutyTypeVM> rs=new ObjResult<DutyTypeVM>(true,null,dtvm.getId(),null);
	...
	public @ResponseBody String  changeDutyTypeUseState(
			...
			ObjResult<DutyTypeVM> rs=new ObjResult<DutyTypeVM>(true,null,0,null);
	...
	public @ResponseBody String  deleteDutyType(
			@RequestParam(value = "id", required = false) String id,
			HttpServletRequest request
			){
			...
			ObjResult<DutyTypeVM> rs=new ObjResult<DutyTypeVM>(isSuccess,msg,0,null);
